...
// 		var uid = '"userEmail=" + $("#userEmail").val() + "&random=" + $("#dice").val()';
		var userEmail = encodeURIComponent(document.getElementById("userEmail"));
		var dice = encodeURIComponent(document.getElementById("dice"));
		
		data = "userEmail"+userEmail+"&dice="+dice;
		//data: "userEmail="+encodeURIComponent($('#userEmail').val()),
		console.dir(data);
		console.dir($("#userEmail").val());
	...
	<div class="column" id="fPw__column">
		...
		<form class="ui large form" action="<%=request.getContextPath()%>/user/fPwEmailCheck" method="post">
			...
			<div class="ui stacked segment">
				...
				<div class="field">
					<input type="text" id="userEmail" name="email" placeholder="E-mail address">
				</div>
				<div class="field">

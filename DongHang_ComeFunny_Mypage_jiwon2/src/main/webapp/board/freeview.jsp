...
<div class = "freeview"> 
	...
	<div class = "freeview__table">
		...
		<tr>			
			<td colspan="2">
			<div class="freeview__table__download">업로드된 파일 : &nbsp; <span> Oracle.png</span></div></td>
	...
	<div class = "freeview__comment__list">
		...
		<div class="freeview__button">
			<div>
				<button class ="freeview__button__list" type="button" onclick="location.href='../board/freelist.jsp'">목록</button>
			</div>
